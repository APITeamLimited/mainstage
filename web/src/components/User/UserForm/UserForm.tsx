    ...
    <div className="rw-form-wrapper">
      <Form onSubmit={onSubmit} error={props.error}>
        ...
        >
          ...
          <CheckboxField
            name="isSupport"
            defaultChecked={props.user?.isSupport}
            className="rw-input"
            errorClassName="rw-input rw-input-error"
          />
        

        <FieldError name="isSupport" className="rw-field-error" />
        ...
        >
          ...
          <CheckboxField
            name="emailVerified"
            defaultChecked={props.user?.emailVerified}
            className="rw-input"
            errorClassName="rw-input rw-input-error"
          />
        ...
        >
          ...
          <TextField
            name="shortBio"
            defaultValue={props.user?.shortBio}
            className="rw-input"
            errorClassName="rw-input rw-input-error"
          />
        

        <FieldError name="shortBio" className="rw-field-error" />
        ...
        >
          ...
          <TextField
            name="profilePicture"
            defaultValue={props.user?.profilePicture}
            className="rw-input"
            errorClassName="rw-input rw-input-error"
          />
